...
class grafo:
    ...
    def printCamino(self, nodos): #Recibe un array de nodos
        for n in nodos : #Para todas las keys
            print(n.getKey())
...
print('Camino:')
result = miGrafo.dfs('2')
miGrafo.printCamino(result)
print('Camino dfs 0:')
result = miGrafo.dfs('04')
miGrafo.printCamino(result)
